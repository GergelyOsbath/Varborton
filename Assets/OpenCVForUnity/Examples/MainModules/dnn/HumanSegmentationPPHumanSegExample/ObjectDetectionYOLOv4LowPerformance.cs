...
namespace OpenCVForUnityExample
{
    ...
    public class ObjectDetectionYOLOv4LowPerformance : MonoBehaviour
    {
        ...
        /// </summary>
        YOLOv4ObjectDetectorLowPerformance objectDetector;
        ...
        void Run()
        {
            ...
            {
                objectDetector = new YOLOv4ObjectDetectorLowPerformance(model_filepath, config_filepath, classes_filepath, new Size(inpWidth, inpHeight), confThreshold, nmsThreshold/*, topK*/);
            }
        ...
        void Update()
        {
            ...
            if (webCamTextureToMatHelper.IsPlaying() && webCamTextureToMatHelper.DidUpdateThisFrame())
            {
                ...
                else
                {
                    ...
                    //objectDetector.visualize_mask(rgbaMat, results, results, 0.5f, true);
